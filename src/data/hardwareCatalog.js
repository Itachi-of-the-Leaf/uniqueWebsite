...
export const HARDWARE_CATALOG = [
  ...
  },
  {
    ...
    front: {
      ...
      hint: 'Tap for configurations & specs ↻',
      badges: [
        {
          label: 'Compact All-in-Ones',
          icon: 'Monitor',
          gradient: 'from-sky-950/80 to-blue-900/60',
          borderColor: 'border-sky-400/50',
          textColor: 'text-sky-200',
    ...
    back: {
      ...
      specs: [
        { icon: 'Cpu', label: 'Intel Core / AMD Ryzen Multi-Core' },
        { icon: 'HardDrive', label: 'High-Speed NVMe Solid State Drives' },
        { icon: 'Laptop', label: 'Lightweight, Long-Battery Staff Laptops' },
  ...
  },
  {
    ...
    front: {
      ...
      hint: 'Tap for duty cycles & connectivity ↻',
      badges: [
        {
          label: 'Print · Scan · Copy (3-in-1)',
          icon: 'Copy',
          gradient: 'from-sky-950/80 to-blue-900/60',
          borderColor: 'border-sky-400/50',
          textColor: 'text-sky-200',
        ...
        {
          label: 'Wi-Fi & LAN Network Sharing',
          icon: 'Wifi',
        ...
        {
          label: 'High-Yield Low Cost/Page',
          icon: 'FileText',
          gradient: 'from-emerald-950/80 to-teal-900/60',
          borderColor: 'border-emerald-400/50',
          textColor: 'text-emerald-200',
        ...
        {
          label: 'Heavy-Duty Auto Duplex ADF',
          icon: 'Printer',
          gradient: 'from-amber-950/60 to-yellow-900/50',
          borderColor: 'border-[#FFD200]/50',
          textColor: 'text-[#FFD200]',
    ...
    back: {
      ...
      title: 'Laser & Tank Multi-Function Printers',
      specs: [
        { icon: 'Printer', label: 'Single-Function & 3-in-1 MFD Units' },
        { icon: 'Wifi', label: 'Wireless Phone & Multi-PC Printing' },
        { icon: 'Copy', label: 'Fast Exam Paper & Document Duplication' },
        { icon: 'ShieldCheck', label: 'Comprehensive Cartridge & Tank Service' },
      ],
  ...
  },
  {
    ...
    front: {
      ...
      badges: [
        ...
        {
          label: 'Extended Battery Runtime',
    ...
    back: {
      ...
      title: 'Offline UPS & Continuous Inverters',
      specs: [
        { icon: 'Zap', label: 'Protects Panels & Labs from Voltage Swings' },
        { icon: 'Clock', label: '4h–8h Classroom Backup Runtimes' },
        { icon: 'Battery', label: 'Heavy-Duty Tubular Battery Sets' },
        { icon: 'Wrench', label: 'Local Battery Maintenance & Replacement' },
      ],
  ...
  },
  {
    ...
    front: {
      ...
      hint: 'Tap for connectivity & input kits ↻',
      badges: [
        {
          label: 'Anti-Glare HD Monitors',
          icon: 'Monitor',
          gradient: 'from-sky-950/80 to-blue-900/60',
          borderColor: 'border-sky-400/50',
          textColor: 'text-sky-200',
        ...
        {
          label: 'Spill-Resistant Keyboard & Mouse',
          icon: 'Keyboard',
        ...
        {
          label: 'High-Speed Shielded HDMI',
          icon: 'Cable',
          gradient: 'from-indigo-950/80 to-purple-900/60',
          borderColor: 'border-indigo-400/50',
          textColor: 'text-indigo-200',
    ...
    back: {
      ...
      specs: [
        { icon: 'Monitor', label: 'FHD Anti-Glare Displays (21.5" & 24")' },
        { icon: 'Keyboard', label: 'School-Grade USB Keyboard & Mouse Combos' },
        { icon: 'Cable', label: 'Reinforced 1.5m / 3m / 5m HDMI Cables' },
        { icon: 'Usb', label: 'High-Speed Class-10 Curriculum USBs' },
      ],
      href: '/catalog/peripherals',
      cta: 'Explore Peripherals ↗',
    },
  },
]
